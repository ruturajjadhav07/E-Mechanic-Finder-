...
<div class="main">
 ...
 <!-- Navbar starts-->
	...
	<div class="scroll-section">
		...
		PreparedStatement ps = con.prepareStatement("SELECT * FROM mechanic");
	    ResultSet rs = ps.executeQuery();
		%>
    <h1>Mechanic's Information</h1>
    <table border="1" >
        <tr>
            <th>Username</th>
            <th>Email</th>
        ...
        %>
            ...
            <tr>
                ...
                <td><%= Address %></td>
                <td>
                    <a href="DeleteUser.jsp?username=<%= UserName %>" class="delete-btn">Delete</a>
                </td>
            </tr>
